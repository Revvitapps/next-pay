...
export default function TerminalCards() {
  return (
    <section className="relative overflow-hidden px-6 py-20 lg:px-12">
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[#46a7a6]/10 to-transparent" />
      <div className="mx-auto w-full max-w-none">
        <MotionDiv>
          <p className="text-sm uppercase tracking-[0.2em] text-[#46a7a6]/85">Infrastructure Options</p>
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {terminalCards.map((card, index) => (
            <motion.article
              ...
              className="group overflow-hidden rounded-3xl border border-[#46a7a6]/25 bg-[#163c4d]/85 shadow-card transition hover:-translate-y-1 hover:border-[#46a7a6]/45"
            >
              <div className="relative border-b border-[#46a7a6]/20 bg-[#163c4d]/75 p-4">
                <div className="absolute inset-0 bg-gradient-to-b from-[#46a7a6]/8 via-transparent to-transparent" />
                <motion.img
                  src={card.image}
                  ...
                  className="relative z-10 h-48 w-full rounded-2xl border border-[#46a7a6]/25 object-cover brightness-125 saturate-125"
                />
              </div>
              <div className="p-5">
                <h3 className="font-heading text-2xl font-bold text-white">{card.name}</h3>
                ...
                <div className="mt-4 inline-flex rounded-full border border-[#46a7a6]/40 bg-[#46a7a6]/10 px-3 py-1 text-xs font-semibold text-white">
