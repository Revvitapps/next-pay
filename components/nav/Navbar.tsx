            ...
            >
              <div className="grid gap-4 lg:grid-cols-4">
                {productMenuColumns.map((column) => (
                  <div key={column.title} className="rounded-xl border border-[#46a7a6]/20 bg-[#163c4d]/75 p-4">
                    ...
                    <div className="mt-2 space-y-1">
                      {column.links.map((linkItem) => (
                        <Link
                          ...
                          className="block rounded-lg px-2 py-1.5 text-sm text-slate-100/90 transition hover:bg-[#46a7a6]/10 hover:text-[#46a7a6]"
                        >
                          {linkItem.label}
                        </Link>
                      ))}
                ...
                <div className="mt-2 grid grid-cols-2 gap-1.5 md:grid-cols-5">
                  {topIndustryLinks.map((industry) => (
                    <Link
                      ...
                      href={industry.href}
                      onClick={() => setIndustriesOpen(false)}
                      className="rounded-lg px-2 py-1.5 text-xs text-slate-100/85 transition hover:bg-[#46a7a6]/10 hover:text-[#46a7a6]"
                    >
                      {industry.label}
                    </Link>
                  ))}
