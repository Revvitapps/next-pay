    ...
    <footer className="border-t border-white/10 px-6 py-8">
      <div className="mx-auto flex w-full max-w-none flex-col gap-4 text-sm text-slate-200/80 md:flex-row md:items-center md:justify-between lg:px-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link href="/services" className="transition hover:text-[#7dd9d8]">
            Services
          </Link>
          <Link href="/capabilities" className="transition hover:text-[#7dd9d8]">
            Capabilities
          </Link>
          <Link href="/industries" className="transition hover:text-[#7dd9d8]">
            Industries
          </Link>
          <Link href="/case-studies" className="transition hover:text-[#7dd9d8]">
            Case Studies
          </Link>
          <Link href="/faq" className="transition hover:text-[#7dd9d8]">
            FAQ
          </Link>
          <Link href="/privacy-policy" className="transition hover:text-[#7dd9d8]">
            Privacy Policy
          </Link>
          <Link href="/terms-of-service" className="transition hover:text-[#7dd9d8]">
            Terms of Service
          </Link>
        </div>
      </div>
