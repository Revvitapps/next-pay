  ...
  return (
    <section className="px-6 py-14 lg:px-12">
      <div className="np-surface mx-auto w-full max-w-[1380px] rounded-3xl p-6 md:p-8">
        {eyebrow ? <p className="np-accent text-xs uppercase tracking-[0.2em]">{eyebrow}</p> : null}
        <h2 className={`${eyebrow ? 'mt-3' : ''} font-heading text-2xl font-extrabold tracking-tight text-white md:text-3xl`}>{title}</h2>
